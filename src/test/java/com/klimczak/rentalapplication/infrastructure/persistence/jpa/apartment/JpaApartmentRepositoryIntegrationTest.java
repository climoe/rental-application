...
import com.klimczak.rentalapplication.domain.apartment.ApartmentAssertion;
...
class JpaApartmentRepositoryIntegrationTest {
    ...
    @Test
    @DisplayName("  given apartment that doesn't exist" +
                 " when trying to find" +
    ...
    @Test
    @Transactional
    @DisplayName("given apartment that exist" +
                " when trying to find " +
                " then return proper")
